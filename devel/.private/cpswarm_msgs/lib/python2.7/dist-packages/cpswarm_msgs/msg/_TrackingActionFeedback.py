...
"""autogenerated by genpy from cpswarm_msgs/TrackingActionFeedback.msg. Do not edit."""
import sys
...
class TrackingActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "cpswarm_msgs/TrackingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpswarm_msgs/TrackingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackingActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cpswarm_msgs.msg.TrackingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cpswarm_msgs.msg.TrackingFeedback()
