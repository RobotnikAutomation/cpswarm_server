...
"""autogenerated by genpy from cpswarm_msgs/PickAndPlaceActionGoal.msg. Do not edit."""
import sys
...
class PickAndPlaceActionGoal(genpy.Message):
  _md5sum = "caf0e0aa4d874e5203ce43627c9ec506"
  _type = "cpswarm_msgs/PickAndPlaceActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cpswarm_msgs/PickAndPlaceGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = cpswarm_msgs.msg.PickAndPlaceGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cpswarm_msgs.msg.PickAndPlaceGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.goal.box_id, _x.goal.target_pose.header.seq, _x.goal.target_pose.header.stamp.secs, _x.goal.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.box_id, _x.goal.target_pose.header.seq, _x.goal.target_pose.header.stamp.secs, _x.goal.target_pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
