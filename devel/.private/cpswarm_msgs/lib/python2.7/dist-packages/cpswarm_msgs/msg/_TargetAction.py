...
"""autogenerated by genpy from cpswarm_msgs/TargetAction.msg. Do not edit."""
import sys
...
class TargetAction(genpy.Message):
  _md5sum = "c8ef7c18b2213bdbca56c845953af7c1"
  _type = "cpswarm_msgs/TargetAction"
...
"""
  ...
  _slot_types = ['cpswarm_msgs/TargetActionGoal','cpswarm_msgs/TargetActionResult','cpswarm_msgs/TargetActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = cpswarm_msgs.msg.TargetActionGoal()
      if self.action_result is None:
        self.action_result = cpswarm_msgs.msg.TargetActionResult()
      if self.action_feedback is None:
        self.action_feedback = cpswarm_msgs.msg.TargetActionFeedback()
    else:
      self.action_goal = cpswarm_msgs.msg.TargetActionGoal()
      self.action_result = cpswarm_msgs.msg.TargetActionResult()
      self.action_feedback = cpswarm_msgs.msg.TargetActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.id, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.id, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
