...
"""autogenerated by genpy from cpswarm_msgs/PickAndPlaceAction.msg. Do not edit."""
import sys
...
class PickAndPlaceAction(genpy.Message):
  _md5sum = "b1a9ebd16477e4743e4c0c8d3881d530"
  _type = "cpswarm_msgs/PickAndPlaceAction"
...
"""
  ...
  _slot_types = ['cpswarm_msgs/PickAndPlaceActionGoal','cpswarm_msgs/PickAndPlaceActionResult','cpswarm_msgs/PickAndPlaceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = cpswarm_msgs.msg.PickAndPlaceActionGoal()
      if self.action_result is None:
        self.action_result = cpswarm_msgs.msg.PickAndPlaceActionResult()
      if self.action_feedback is None:
        self.action_feedback = cpswarm_msgs.msg.PickAndPlaceActionFeedback()
    else:
      self.action_goal = cpswarm_msgs.msg.PickAndPlaceActionGoal()
      self.action_result = cpswarm_msgs.msg.PickAndPlaceActionResult()
      self.action_feedback = cpswarm_msgs.msg.PickAndPlaceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.box_id, _x.action_goal.goal.target_pose.header.seq, _x.action_goal.goal.target_pose.header.stamp.secs, _x.action_goal.goal.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.box_id, _x.action_goal.goal.target_pose.header.seq, _x.action_goal.goal.target_pose.header.stamp.secs, _x.action_goal.goal.target_pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
