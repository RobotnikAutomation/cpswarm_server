...
"""autogenerated by genpy from cpswarm_msgs/AreaDivisionEvent.msg. Do not edit."""
import sys
...
class AreaDivisionEvent(genpy.Message):
  _md5sum = "bc68a77f3ebb69a548eb09351fe4ca61"
  _type = "cpswarm_msgs/AreaDivisionEvent"
...
float64 w
"""
  __slots__ = ['header','swarmio','pose']
  _slot_types = ['std_msgs/Header','swarmros/EventHeader','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AreaDivisionEvent, self).__init__(*args, **kwds)
