...
"""autogenerated by genpy from cpswarm_msgs/TrackingActionResult.msg. Do not edit."""
import sys
...
class TrackingActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "cpswarm_msgs/TrackingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpswarm_msgs/TrackingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cpswarm_msgs.msg.TrackingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cpswarm_msgs.msg.TrackingResult()
