...
"""autogenerated by genpy from cpswarm_msgs/PickAndPlaceGoal.msg. Do not edit."""
import sys
...
class PickAndPlaceGoal(genpy.Message):
  _md5sum = "f7247c6ee9f5f72bd29e2c7e6b76c108"
  _type = "cpswarm_msgs/PickAndPlaceGoal"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.box_id, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.box_id, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
