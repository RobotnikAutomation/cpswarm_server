...
"""autogenerated by genpy from cpswarm_msgs/EmptyActionFeedback.msg. Do not edit."""
import sys
...
class EmptyActionFeedback(genpy.Message):
  ...
  _type = "cpswarm_msgs/EmptyActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpswarm_msgs/EmptyFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = cpswarm_msgs.msg.EmptyFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cpswarm_msgs.msg.EmptyFeedback()
