...
"""autogenerated by genpy from cpswarm_msgs/TargetActionGoal.msg. Do not edit."""
import sys
...
class TargetActionGoal(genpy.Message):
  _md5sum = "e206e9d43c49b8f5324768860b5c5a2d"
  _type = "cpswarm_msgs/TargetActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cpswarm_msgs/TargetGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TargetActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cpswarm_msgs.msg.TargetGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cpswarm_msgs.msg.TargetGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.goal.id, _x.goal.pose.header.seq, _x.goal.pose.header.stamp.secs, _x.goal.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.id, _x.goal.pose.header.seq, _x.goal.pose.header.stamp.secs, _x.goal.pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
