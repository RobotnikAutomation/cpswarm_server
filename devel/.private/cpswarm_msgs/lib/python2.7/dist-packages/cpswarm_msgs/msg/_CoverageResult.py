...
"""autogenerated by genpy from cpswarm_msgs/CoverageResult.msg. Do not edit."""
import sys
...
class CoverageResult(genpy.Message):
  _md5sum = "fcc669309162d4fa6dc359bea359f549"
  _type = "cpswarm_msgs/CoverageResult"
...
float64 w
"""
  __slots__ = ['target_id','target_pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CoverageResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.target_id, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target_id, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
