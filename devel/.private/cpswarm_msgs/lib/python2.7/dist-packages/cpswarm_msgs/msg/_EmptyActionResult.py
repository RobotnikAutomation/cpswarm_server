...
"""autogenerated by genpy from cpswarm_msgs/EmptyActionResult.msg. Do not edit."""
import sys
...
class EmptyActionResult(genpy.Message):
  ...
  _type = "cpswarm_msgs/EmptyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpswarm_msgs/EmptyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = cpswarm_msgs.msg.EmptyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cpswarm_msgs.msg.EmptyResult()
