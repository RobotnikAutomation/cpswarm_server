...
class CoverageActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CoverageResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CoverageResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CoverageActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = CoverageResult.Resolve(msg.result)
    }
    else {
      resolved.result = new CoverageResult()
    }
...
module.exports = CoverageActionResult;
