...
class CoverageActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CoverageGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CoverageActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CoverageGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CoverageGoal()
    }
...
module.exports = CoverageActionGoal;
