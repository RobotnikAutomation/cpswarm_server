...
class TargetActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TargetFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TargetFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TargetActionFeedback(null);
    ...
    data.feedback = TargetFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TargetActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TargetFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TargetFeedback()
    }
...
module.exports = TargetActionFeedback;
