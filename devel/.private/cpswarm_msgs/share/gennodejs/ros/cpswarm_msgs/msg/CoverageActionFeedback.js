...
class CoverageActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CoverageFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CoverageFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CoverageActionFeedback(null);
    ...
    data.feedback = CoverageFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CoverageActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CoverageFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CoverageFeedback()
    }
...
module.exports = CoverageActionFeedback;
