...
class TargetActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TargetGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TargetGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TargetActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TargetGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TargetGoal()
    }
...
module.exports = TargetActionGoal;
