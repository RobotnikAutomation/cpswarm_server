...
class TrackingActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TrackingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TrackingGoal()
    }
...
module.exports = TrackingActionGoal;
