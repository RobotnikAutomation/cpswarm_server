...
class TrackingActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TrackingFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrackingFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrackingActionFeedback(null);
    ...
    data.feedback = TrackingFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackingActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrackingFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrackingFeedback()
    }
...
module.exports = TrackingActionFeedback;
