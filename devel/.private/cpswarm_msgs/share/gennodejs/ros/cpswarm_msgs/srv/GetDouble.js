...
class GetDoubleRequest {
  ...
  static datatype() {
    ...
    return 'cpswarm_msgs/GetDoubleRequest';
  }
...
class GetDoubleResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cpswarm_msgs/GetDoubleResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '1b1594d2b74931ef8fe7be8e2d594455'; },
  datatype() { return 'cpswarm_msgs/GetDouble'; }
};
