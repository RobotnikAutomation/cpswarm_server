...
if("TRUE" STREQUAL "TRUE")
  set(communication_SOURCE_PREFIX /home/miguel/ws/cpswarm_server/src/communication)
  set(communication_DEVEL_PREFIX /home/miguel/ws/cpswarm_server/devel/.private/communication)
  ...
  set(communication_INSTALL_PREFIX /home/miguel/ws/cpswarm_server/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Micha Sende <sende@lakeside-labs.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miguel/ws/cpswarm_server/src/communication/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/miguel/ws/cpswarm_server/devel/.private/communication/lib;/home/miguel/ws/cpswarm_server/devel/lib;/opt/ros/kinetic/lib)
