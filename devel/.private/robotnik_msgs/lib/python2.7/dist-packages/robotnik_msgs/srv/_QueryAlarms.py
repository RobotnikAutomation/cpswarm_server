...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.top))
      _x = self.filter_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.type_query = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.start_date = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.end_date = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.filter_type = str[start:end].decode('utf-8')
      else:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.alarms:
        buff.write(_get_struct_i().pack(val1.alm_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.alm_component = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.alm_type = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.alm_group = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.alm_description = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.alm_start_time = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.alm_end_time = str[start:end].decode('utf-8')
        else:
