...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.lasers_status:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.warning_zones))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.safety_mode = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.lasers_mode.name = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        val1.warning_zones = struct.unpack(pattern, str[start:end])
        val1.warning_zones = map(bool, val1.warning_zones)
