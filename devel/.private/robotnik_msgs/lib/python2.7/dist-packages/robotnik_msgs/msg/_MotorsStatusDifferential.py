...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.lwStatus.analoginputs))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.rwStatus.analoginputs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.lwStatus.analoginputs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.rwStatus.analoginputs = struct.unpack(pattern, str[start:end])
      return self
