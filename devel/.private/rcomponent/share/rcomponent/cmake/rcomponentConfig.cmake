...
if("TRUE" STREQUAL "TRUE")
  set(rcomponent_SOURCE_PREFIX /home/miguel/ws/cpswarm_server/src/rcomponent)
  set(rcomponent_DEVEL_PREFIX /home/miguel/ws/cpswarm_server/devel/.private/rcomponent)
  ...
  set(rcomponent_INSTALL_PREFIX /home/miguel/ws/cpswarm_server/install)
...
if(NOT "/home/miguel/ws/cpswarm_server/src/rcomponent/include " STREQUAL " ")
  set(rcomponent_INCLUDE_DIRS "")
  set(_include_dirs "/home/miguel/ws/cpswarm_server/src/rcomponent/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rcomponent' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miguel/ws/cpswarm_server/src/rcomponent/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/miguel/ws/cpswarm_server/devel/.private/rcomponent/lib;/home/miguel/ws/cpswarm_server/devel/lib;/opt/ros/kinetic/lib)
